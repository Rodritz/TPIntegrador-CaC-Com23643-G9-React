                ...
                <div className="col">
                    ...
                    <form onSubmit={createTrago}>
                        ...
                        <div className="mb-3">
                            ...
                            <input className="form-control" type="text" onChange={(e) => setIngredientes(e.target.value)} />
                        </div>

                        <div className="mb-3">
                            <label className="form-label">INSTRUCCIONES</label>
                            <input className="form-control" type="text" onChange={(e) => setInstrucciones(e.target.value)} />
                        </div>

                        <div className="mb-3">
                            <label className="form-label">CATEGORIA</label>
                            <input className="form-control" type="text" onChange={(e) => setCategoria(e.target.value)} />
                        </div>

                        <button type="submit" className="btn btn-secondary">ACEPTAR</button>
                        <Link to="/show" className="btn btn-danger">CANCELAR</Link>
                    </form>
                </div>
            </div>
        </div>
